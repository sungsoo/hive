...
public class TestHBaseMinimrCliDriver extends TestCase {
  ...
  protected void setUp() {
    ...
    try {
      qt = new HBaseQTestUtil((HIVE_ROOT + "hbase-handler/src/test/results/positive/"), (HIVE_ROOT + "itests/qtest/target/qfile-results/hbase-handler/minimrpositive/"), miniMR, setup);
    } catch (Exception e) {
  ...
  public static Test suite() {
    ...
    if(qFilesToExecute.isEmpty() || qFilesToExecute.contains("hbase_bulk.m")) {
  ...
  public void testCliDriver_hbase_bulk() throws Exception {
    runTest("hbase_bulk", "hbase_bulk.m", (HIVE_ROOT + "hbase-handler/src/test/queries/positive/hbase_bulk.m"));
  }
