 ...
 */
public class StringColEqualStringScalar extends VectorExpression {
  ...
  public StringColEqualStringScalar(int colNum, byte[] value, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public StringColEqualStringScalar() {
  }
