 ...
 */
public class StringColGreaterEqualStringScalar extends VectorExpression {
  ...
  public StringColGreaterEqualStringScalar(int colNum, byte[] value, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public StringColGreaterEqualStringScalar() {
  }
