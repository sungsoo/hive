 ...
 */
public class StringColGreaterStringScalar extends VectorExpression {
  ...
  public StringColGreaterStringScalar(int colNum, byte[] value, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public StringColGreaterStringScalar() {
  }
