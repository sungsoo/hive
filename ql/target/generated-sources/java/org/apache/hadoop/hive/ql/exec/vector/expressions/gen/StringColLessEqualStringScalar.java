 ...
 */
public class StringColLessEqualStringScalar extends VectorExpression {
  ...
  public StringColLessEqualStringScalar(int colNum, byte[] value, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public StringColLessEqualStringScalar() {
  }
