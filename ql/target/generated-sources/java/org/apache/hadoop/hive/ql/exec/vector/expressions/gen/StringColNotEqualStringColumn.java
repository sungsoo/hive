 ...
 */
public class StringColNotEqualStringColumn extends VectorExpression {
  ...
  public StringColNotEqualStringColumn(int colNum1, int colNum2, int outputColumn) { 
    this.colNum1 = colNum1;
    this.colNum2 = colNum2;
    this.outputColumn = outputColumn;
  }

  public StringColNotEqualStringColumn() {
  }
