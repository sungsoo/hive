 ...
 */
public class StringColNotEqualStringScalar extends VectorExpression {
  ...
  public StringColNotEqualStringScalar(int colNum, byte[] value, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public StringColNotEqualStringScalar() {
  }
