 ...
 */
public class StringScalarEqualStringColumn extends VectorExpression {
  ...
  public StringScalarEqualStringColumn(byte[] value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public StringScalarEqualStringColumn() {
  }
