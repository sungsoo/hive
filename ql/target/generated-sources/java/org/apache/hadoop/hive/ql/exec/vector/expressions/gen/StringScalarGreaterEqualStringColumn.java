 ...
 */
public class StringScalarGreaterEqualStringColumn extends VectorExpression {
  ...
  public StringScalarGreaterEqualStringColumn(byte[] value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public StringScalarGreaterEqualStringColumn() {
  }
