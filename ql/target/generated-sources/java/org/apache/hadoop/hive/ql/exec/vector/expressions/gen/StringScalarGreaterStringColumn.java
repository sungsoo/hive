 ...
 */
public class StringScalarGreaterStringColumn extends VectorExpression {
  ...
  public StringScalarGreaterStringColumn(byte[] value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public StringScalarGreaterStringColumn() {
  }
