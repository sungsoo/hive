 ...
 */
public class StringScalarLessEqualStringColumn extends VectorExpression {
  ...
  public StringScalarLessEqualStringColumn(byte[] value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public StringScalarLessEqualStringColumn() {
  }
