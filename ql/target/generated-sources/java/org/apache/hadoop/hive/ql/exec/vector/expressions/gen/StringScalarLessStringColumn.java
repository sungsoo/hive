 ...
 */
public class StringScalarLessStringColumn extends VectorExpression {
  ...
  public StringScalarLessStringColumn(byte[] value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public StringScalarLessStringColumn() {
  }
