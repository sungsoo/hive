 ...
 */
public class StringScalarNotEqualStringColumn extends VectorExpression {
  ...
  public StringScalarNotEqualStringColumn(byte[] value, int colNum, int outputColumn) {
    this.colNum = colNum;
    this.value = value;
    this.outputColumn = outputColumn;
  }

  public StringScalarNotEqualStringColumn() {
  }
